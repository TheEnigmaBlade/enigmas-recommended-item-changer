package net.enigmablade.lol.lolitem.util;
...
public class UpdateUtil
{
	...
	private static final String[] cacheFiles = {"items.xml", "game_version.txt"};
	...
	{
		File dir = new File(System.getProperty("java.io.tmpdir")+"Enigma_Update_"+EnigmaItems.appKey);
